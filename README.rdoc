...
Of course, the Arpeggiator needs notes to work with.  For the sake of simplicity, I'm just going to enter a chord with Ruby code.  However, as you might expect, it is also possible to use a MIDI input. ({see example}[http://github.com/arirusso/diamond/blob/master/examples/midi_input.rb])
