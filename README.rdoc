...
If you are using this example in irb, you can start the arpeggiator in a background thread.  That will allow you to {live code}[http://en.wikipedia.org/wiki/Live_coding] its parameters or sync it to another arpeggiator. 
   
  arp.start(:background => true)
  
Read more about {live coding}[http://en.wikipedia.org/wiki/Live_coding] with diamond {here}[blogpost].
