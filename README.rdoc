...
If you are using this example in irb, you can start the arpeggiator in a background thread by passing :background => true to Arpeggiator#start.  That will allow you to {live code}[http://en.wikipedia.org/wiki/Live_coding], sync it to another arpeggiator, or just run another foreground process. 
