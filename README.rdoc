...
* {Preset}[http://github.com/arirusso/diamond/blob/master/lib/diamond/pattern_presets.rb] and {user-definable}[http://github.com/arirusso/diamond/blob/master/examples/define_pattern.rb] pattern algorithms 
