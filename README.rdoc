...
The Arpeggiator has a number of options that you can control. {Click here}[http://tx81z.blogspot.com/] for a more in-depth explanation of these options.
...
Read about {syncing}[http://tx81z.blogspot.com/] multiple Arpeggiators and {Topaz tempo generators}[http://github.com/arirusso/topaz] {http://tx81z.blogspot.com/}[blogpost]
