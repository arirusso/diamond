...
* Control via {OSC}[http://en.wikipedia.org/wiki/Open_Sound_Control]
...
{inst}[http://github.com/arirusso/inst], {midi-eye}[http://github.com/arirusso/midi-eye], {midi-message}[http://github.com/arirusso/midi-message], {topaz}[http://github.com/arirusso/topaz], and {unimidi}[http://github.com/arirusso/unimidi]
