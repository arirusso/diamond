...
This screencast video above shows Diamond being live coded in this way. ({Read how this is done}[http://tx81z.blogspot.com])

And check out the following links and examples to learn about more functionality
