...
Use Arpeggiator#add and Arpeggiator#remove to change the notes that the arpeggiator sees.  
  ...
  # or use << which is the same as add
...
{This screencast video}[http://vimeo.com/25948428] shows Diamond being live coded in this way... {and this blog post explains}[http://tx81z.blogspot.com/2011/07/live-coding-with-diamond.html]
