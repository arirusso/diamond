...
The Arpeggiator has a number of {optional parameters}[http://rdoc.info/gems/diamond/0.0.2/Diamond/Arpeggiator:initialize].  For this example, here's a straightforward setup
...
All of the {arpeggiator options}[http://rdoc.info/gems/diamond/0.0.2/Diamond/Arpeggiator:initialize] can be controlled on the on the fly

  arp.rate = 16
  arp.gate = 20  
  arp.remove(["C5", "A4"])
  
This screencast video shows Diamond being live coded in this way. ({Read how this is done}[http://tx81z.blogspot.com])
