...
The Arpeggiator has a number of options to control. {Click here}[http://tx81z.blogspot.com/] for a more in-depth explanation of these options.
...
You can then control all of the options on the fly
