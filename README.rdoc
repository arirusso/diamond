...
The screencast video above shows Diamond being live coded in this way. ({Read how this is done}[http://tx81z.blogspot.com])

==== Links:

* {Example of syncing Diamond to external MIDI clock}[http://github.com/arirusso/diamond/blob/master/examples/sync_to_midi_clock.rb]
...
* {Example of feeding notes to Diamond using MIDI message objects}[http://github.com/arirusso/diamond/blob/master/examples/midi_message_objects.rb]
* {Live coding Diamond and syncing multiple arpeggiators to each other}[http://tx81z.blogspot.com] 
